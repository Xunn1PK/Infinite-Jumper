...
//Start button
var button = new UIButton("ButtonMainMenuStart", 0, -75, 200, 75, TID("UI", "start"), spr_baseui_button, UI_RELATIVE_TO.MIDDLE_CENTER);
...
//Exit button
button = new UIButton("ButtonMainMenuExit", 0, 75, 200, 75, TID("UI", "exit"), spr_baseui_button, UI_RELATIVE_TO.MIDDLE_CENTER);
button.setImageMouseover(1).setImageClick(2).setCallback(UI_EVENT.LEFT_RELEASE, function(){
