...
var lvl_num_text = new UIText("LevelNum_text", 0, -106, $"[scale, 0.75]{TID("level")} {selected_lvl}[/scale]");
...
var button_start = new UIButton("LevelSelect_start", 0, 200, 150, 75, $"[scale, 1.25]{TID("start")}[/scale]", spr_baseui_button, UI_RELATIVE_TO.MIDDLE_CENTER);
...
button_left.setCallback(UI_EVENT.LEFT_RELEASE, function(){
    ...
    ui_get("LevelNum_text").setText($"[scale, 0.75]{TID("level")} {selected_lvl}[/scale]");
});
